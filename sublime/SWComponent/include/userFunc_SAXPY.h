...
void SLAVE_FUNC(userFunc_aEaMib)(MVM_Arrays*);
void SLAVE_FUNC(userFunc_aEaDb)(MVM_Arrays*);
...
void SLAVE_FUNC(userFunc_residualSumKSqr)(MVM_Arrays*);
...
void SLAVE_FUNC(userFunc_sumSqrDot)(MVM_Arrays*);
